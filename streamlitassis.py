...
#             print("\033[91m {}\033[00m" .format("YOU SAID : "+user_response))
            st.write(f'<p style="font-family: sans-serif;font-size: 15px;text-align:right;text-transform: capitalize;background-color: #190380;padding: 18px;border-radius: 15px">{user_response}</p>', unsafe_allow_html=True)
